...
- **EdgeHistoryPopup**:
  ...
  - Tự động nhận diện và chuyển đổi biểu tượng (icon) nền tối cho người dùng Chrome giao diện sáng (Light theme) tức thì ngay khi cài đặt qua Offscreen Document (`MATCH_MEDIA`), không cần click vào popup.
  - Hiển thị biểu tượng ứng dụng rõ nét, viền bo góc nổi bật trên trang quản lý `chrome://extensions/` (không bị trắng xóa/tàng hình).
- **EdgeDownloadsPopup**:
  ...
  - Tự động chuyển đổi biểu tượng nền tối (Dark background icon) cho Chrome theme sáng theo thiết lập hệ thống/trình duyệt (`prefers-color-scheme`), kích thước glyph Scale 1.0 to bằng nhau tuyệt đối với theme tối, nhận diện chủ động qua Offscreen Document ngay khi cài đặt.
  - Hiển thị biểu tượng ứng dụng rõ nét trên trang quản lý `chrome://extensions/`.
